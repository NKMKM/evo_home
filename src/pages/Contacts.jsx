...
const Contacts = () => {
  return (
    ...
    <div>
        {/* contacts evo home */}
        <div className='w-[1641px] h-[1297px]  mx-auto my-20' >
            ...
            <div className='h-[83px] w-full mx-auto flex flex-row justify-between items-center mb-20 '>
                ...
                <div className=''>
                    <h1 className='font-bold text-center text-[70px]'>Контакты EVO HOME</h1>

                </div>
                <img src={right_decoration} className='w-[276px] h-[83px]'/>
            </div>

            <div className='w-[1641px] h-[1101px]  flex flex-col justify-between'>
                <p className='text-[32px] my-2'>Мы всегда готовы выслушать вас и пообщаться с вами! Ниже вы найдете все необходимые контакты, чтобы обсудить с нами ваш проект, задать вопросы или оставить отзыв.</p>

                <div className='w-[1640px] h-[742px]  flex flex-row justify-between'>
                    
                    <ul className='flex flex-col justify-between w-[694px] h-[742px]'>
                        <li>
                        ...
                        <li>
                            <div className='w-full h-[132px] bg-[#F9B33B] relative p-5'>
                                <div className='flex flex-row justify-between'>
                    ...
                    <div>
                        <iframe className='border-[4px] border-[#F9B33B]' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2968.700851227668!2d12.523739276689986!3d41.92078916273934!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880b544c576ff2bd%3A0x3fc93aeeff10730d!2sEvo%20Home%20Ristrutturazioni!5e0!3m2!1sru!2s!4v1748806214394!5m2!1sru!2s" width="834" height="742"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>

                <div className='w-[1640px] h-[163px] flex flex-row justify-between'>
                    <div className='w-[692px] h-[163px] bg-[#F9B33B] relative p-5'>
                        <div className='flex flex-row justify-between'>
                    ...
                    <div className='flex items-center justify-end w-[951px] h-[163px] border-[4px] border-[#F9B33B]'>
                        <ul className='w-[834px] h-[92px] flex flex-row justify-between pr-4  '>
        ...
        <div className='contact-form-bg-image bg-center w-[1920px] h-[650px] '>
            <h1 className='text-white text-[70px] text-center font-semibold'>Свяжись с нами</h1>
            <form className='flex flex-col w-[1361px] h-[470px] justify-between  text-white mx-auto'>
                <div className='flex flex-row justify-between'>
                    <div className='w-[388px] h-[104px] flex flex-col'>
                        <label className='mb-3'>ИМЯ</label>
                        <input type='text' placeholder='Ваше Имя...' className='w-[388px] h-[63px] border-[3px] border-[#F9B33B] p-3'/>
                    </div>
                    <div className='w-[388px] h-[104px] flex flex-col'>
                        <label className='mb-3'>E-MAIL</label>
                        <input type='text' placeholder='Ваш e-mail...' className='w-[388px] h-[63px] border-[3px] border-[#F9B33B] p-3'/>
                    </div>
                    <div className='w-[388px] h-[104px] flex flex-col'>
                        <label className='mb-3'>ГОРОД</label>
                        <input type='text' placeholder='Ваш город...' className='w-[388px] h-[63px] border-[3px] border-[#F9B33B] p-3'/>
                    </div>
                ...
                <div className='flex flex-col'>
                    ...
                    <textarea name="" id="" placeholder='Напишите...' className='w-full border-[3px] border-[#F9B33B] h-[200px] p-3 bg-gray-300/20'></textarea>
                </div>

                <button type='submit' className='text-black font-bold w-[315px] h-[55px] bg-[#F9B33B] mx-auto button-scale-hover text-2xl'>ОТПРАВИТЬ</button>
            </form>
        </div>
    </div>
  )
