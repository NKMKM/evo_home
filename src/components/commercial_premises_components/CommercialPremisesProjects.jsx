...
import second_image from '../../assets/images/commercial_premises/grid_images/second_image.jpg'
import third_image from '../../assets/images/commercial_premises/grid_images/third_image.jpg'
import fourth_image from '../../assets/images/commercial_premises/grid_images/fourth_image.jpg'
import fifth_image from '../../assets/images/commercial_premises/grid_images/fifth_image.jpg'
import sixth_image from '../../assets/images/commercial_premises/grid_images/sixth_image.jpg'
    ...
    <div className='mb-20 w-[1641px] mx-auto'>
        ...
        <div className="grid grid-cols-3 grid-rows-2 gap-y-4 mb-10">
            ...
            <div className="relative w-[528px] h-[407px] group overflow-hidden">
                <img src={first_step} className="w-full h-full object-cover transition-all duration-300 group-hover:brightness-50" />
                <div className="absolute bottom-[20px] bg-gradient-to-r from-blue-300/90 via-90% via-white/0 left-0 text-white h-[65px] w-full flex items-center px-4 z-10">
                    <h1 className="text-[32px]">Бизнес-центры</h1>
                </div>
