...
const Calculator = () => {
  ...
  return (
    <div className='mt-20 w-full h-[865px] border-2 home-calculator-bg-image bg-center bg-cover py-10'>
      {/* Заголовок */}
      <div className='flex flex-row items-center w-[1252px] h-[85px] text-white mx-auto space-x-10'>
        <img src={calculator} className='w-[64px] h-[64px]' />
        <h1 className='font-[600] text-[60px]'>Калькулятор стоимости ремонта</h1>
      </div>

      {/* Подзаголовок */}
      <p className='text-white w-[1518px] h-[76px] mx-auto text-center my-10 p-light italic text-xl'>
      ...
      {/* Основной контейнер */}
      <div className='w-[1350px] mx-auto flex flex-row'>

        {/* Левая форма */}
        <form className="w-2/3 h-[490px]  p-6 rounded-lg text-white">
          <div className="flex flex-col space-y-12">
            {/* Первая строка */}
            <div className='flex flex-row space-x-8.5'>
              <div className='flex flex-col'>
                <label className="text-[18px] text-[#F9B33B] font-semibold">ТИП ЗДАНИЯ</label>
                  <select
                    className="w-[250px] h-[63px] border-[3px] text-white border-yellow-500 rounded px-2 py-1 "
                  >
        ...
        {/* Разделитель */}
        <div className='flex w-[89px] h-[50px] border-r-[10px] border-r-[#F9B33B] border-l-[10px] border-l-[#F9B33B] items-center mt-[200px] mr-[20px]'>
          <div className='w-full h-[10px] bg-[#F9B33B]'></div>
        </div>

        {/* Правая форма */}
        <form className='relative bg-white border-[3px] border-[#F9B33B] rounded-[10px] w-[389px] h-[430px] p-10'>
          <div className="mb-4">
