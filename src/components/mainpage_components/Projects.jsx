...
const Projects = () => {
  return (
    <div className='mb-20 w-[1641px] mx-auto'>
        ...
        <p className='w-[1410px] h-[76px] mx-auto text-[32px] text-center font-[100] italic mb-20'>"Ваш дом – наша работа"</p>
        
        {/* grid section with projects */}
        <div className='grid grid-cols-3 grid-rows-2 gap-y-4 mb-10'>

            {/* first element */}
            <div className='relative w-[528px] h-[407px] group '>
        ...
        <div className='w-[1641px] flex flex-row items-center mx-auto'>

            <div className='h-[1px] w-[625.5px] bg-[#F9B33B]'></div>

            <button className='w-[389px] h-[67px] bg-[#F9B33B] text-[30px] font-semibold'>ПОДРОБНЕЕ</button>
