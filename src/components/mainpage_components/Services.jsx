...
const Services = () => {
  return (
    <>
        <div className='my-40 w-[1641px] mx-auto'>
            {/* header section */}
            
            <div className='h-[170px] w-full mx-auto flex flex-row justify-between items-center mb-20 '>
                <img src={left_decoration} className='w-[276px] h-[83px] '/>
                <div className=''>
                    <h1 className='font-bold text-center text-[60px]'>Ваш дом в надежных руках</h1>
                    <h1 className='font-bold text-center text-[70px]'>Наши услуги</h1>
                </div>
                <img src={right_decoration} className='w-[276px] h-[83px]'/>
            </div>

            <p className='w-[1410px] h-[76px] mx-auto text-[32px] text-center font-[100] italic mb-20'>"EVO HOME  выполнит ремонт квартир любой сложности – от легкого косметического обновления до капитального ремонта с перепланировкой."</p>
            
            {/* list of services */}
            <div className='w-[1641px] '>
                <ul className='w-[1641px] mx-auto flex flex-row justify-between '>
                    {/* first element */}
                    <li className='w-[389px] h-[933px]  flex flex-col justify-between py-2'>
                        ...
                        <div className='w h-[778px]  flex flex-col shadow-xl'>
                            ...
                            <div className='h-1/2  text-center items-center pt-5 space-y-5'>
                                <img src={keys} className='w-[79px] h-[79px] mx-auto'/>
                                <p className='text-[22px]'>Выполняем косметический, капитальный и дизайнерский ремонт с заменой всех коммуникаций. Качество, сроки, гарантия!</p>
                            </div>
                        </div>
                    ...
                    <li className='w-[389px] h-[933px]  flex flex-col justify-between py-2'>
                        ...
                        <div className='w h-[778px]  flex flex-col shadow-xl'>
                            ...
                            <div className='h-1/2  text-center items-center pt-5 space-y-5'>
                                <img src={room} className='w-[79px] h-[79px] mx-auto'/>
                                <p className='text-[22px]'>Обновим интерьер вашей гостиной, спальни, кухни или ванной. Быстро и качественно выполним отделку, монтаж полов, освещение, натяжные потолки.</p>
                            </div>
                        </div>
                    ...
                    {/* third element */}
                    <li className='w-[389px] h-[933px]  flex flex-col justify-between pb-[12px]'>
                        ...
                        <div className='w h-[778px]  flex flex-col shadow-xl'>
                            ...
                            <div className='h-1/2  text-center items-center pt-5 space-y-5'>
                                <img src={botique} className='w-[79px] h-[79px] mx-auto'/>
                                <p className='text-[22px]'>Создаем стильные и функциональные офисы, магазины, рестораны, салоны. Разрабатываем дизайн, выполняем отделку и подключаем инженерные системы.</p>
                            </div>
                        </div>
                    ...
                    <li className='w-[389px] h-[933px]  flex flex-col justify-between py-2'>
                        ...
                        <div className='w h-[778px]  flex flex-col shadow-xl'>
                            ...
                            <div className='h-1/2  text-center items-center pt-5 space-y-5'>
                                <img src={gears} className='w-[79px] h-[79px] mx-auto'/>
                                <p className='text-[22px]'>Монтаж и обслуживание электрики, сантехники, отопления, вентиляции. Надежные решения для вашего комфорта и безопасности.</p>
                            </div>
                        </div>
