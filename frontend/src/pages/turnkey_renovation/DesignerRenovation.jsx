...
const DesignerRenovation = () => {
  ...
  return (
    <div>
        ...
        {/* first step */}
        <header className={`${selectedLang === 'en' ? 'lg:h-[1425px] ' : 'lg:h-[1525px] '} lg:w-[1641px]  sm:w-full mx-auto my-20 flex flex-col justify-between`}>
            {/* header */}
            ...
            <div className='space-y-10'>
                ...
                {/* image */}
                <div className='sm:w-full lg:w-[1641px] lg:h-[661px] bg-blue-600/20'><img src={image} alt='designer renovation' loading="lazy" className='w-full h-full object-cover rounded-[10px]' /></div>
        ...
        {/* process */}
        <main className='lg:w-full lg:h-[3688px]  flex flex-col justify-between'>
            {/* header */}
            <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] mx-auto flex flex-row'>
                ...
                <h2 className={`${selectedLang === 'it' ? 'sm:text-[23px] sm:mt-5' : 'sm:text-[28px] sm:mt-4'} lg:text-[50px] font-bold sm:mt-4 lg:mt-0`}>{t('process.h')}</h2>
            </div>
