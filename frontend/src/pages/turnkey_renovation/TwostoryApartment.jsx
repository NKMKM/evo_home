      ...
      <header className="w-full max-w-[1641px] mx-auto my-6 sm:my-8 lg:my-10 flex flex-col justify-between px-4 lg:px-0">
        ...
        <div className="space-y-6 sm:space-y-8 lg:space-y-10">
          <div className="w-full h-[60px] sm:h-[74px] bg-[#F9B33B] flex flex-row items-center">
            ...
            <h2 className={`${selectedLang === 'it' ? 'text-[18px] sm:text-[20px]' : 'text-[20px] sm:text-[24px]'} lg:text-[54px] font-bold mt-1 lg:mt-0`}>{t('header.h')}</h2>
          </div>
          ...
          <div className="w-full bg-blue-600/20 rounded-[10px] overflow-hidden">
            <img src={image} alt='twostory apartment' loading="lazy" className="w-full h-auto object-cover" />
          </div>
          ...
          <ul className="w-full max-w-[1641px] mx-auto flex flex-col space-y-8 sm:space-y-10 lg:space-y-12">
            <li className="w-full sm:w-[90%] lg:w-full mx-auto flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="w-full lg:w-[1082px] flex flex-col space-y-4 py-4 px-4 sm:px-6 lg:px-8">
                ...
                <p className="text-[16px] sm:text-[20px] lg:text-[26px]">{t('process.ul.1.p')}</p>
              </div>
            </li>
            ...
            <li className="w-full sm:w-[90%] lg:w-full mx-auto flex flex-col lg:flex-row-reverse justify-between items-center">
              ...
              <div className="w-full lg:w-[1082px] flex flex-col space-y-4 py-4 px-4 sm:px-6 lg:px-8">
                ...
                <p className="text-[16px] sm:text-[20px] lg:text-[26px]">{t('process.ul.2.p')}</p>
              </div>
            </li>
            ...
            <li className="w-full sm:w-[90%] lg:w-full mx-auto flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="w-full lg:w-[1082px] flex flex-col space-y-4 py-4 px-4 sm:px-6 lg:px-8">
                ...
                <p className="text-[16px] sm:text-[20px] lg:text-[26px]">{t('process.ul.3.p')}</p>
              </div>
            </li>
            ...
            <li className="w-full sm:w-[90%] lg:w-full mx-auto flex flex-col lg:flex-row-reverse justify-between items-center">
              ...
              <div className="w-full lg:w-[1082px] flex flex-col space-y-4 py-4 px-4 sm:px-6 lg:px-8">
                <h2 className="font-bold text-[24px] sm:text-[28px] lg:text-[44px]">{t('process.ul.4.h')}</h2>
                <p className="text-[16px] sm:text-[20px] lg:text-[26px]">{t('process.ul.4.p')}</p>
              </div>
            </li>
          </ul>

          <div className="absolute top-[1100px] sm:top-[1290px] left-[180px] sm:left-[280px] w-[1100px] sm:w-[1303px] h-[400px] sm:h-[460px] scale-x-85 hidden lg:block">
