...
const TwostoryApartment = () => {
  return (
    <div>
        <Helmet>
            <title>Ремонт двухэтажной квартиры</title>
        ...
        <header className='lg:w-[1641px] sm:w-full lg:h-[1475px] mx-auto my-20 flex flex-col justify-between'>
            ...
            <div className='space-y-10'>
                ...
                <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] flex flex-row'>
                    ...
                    <h2 className='sm:text-[24px] lg:text-[50px] font-bold sm:mt-4.5 lg:mt-0'>Ремонт двухэтажной квартиры от EVO HOME</h2>
                </div>
                ...
                {/* image */}
                <div className='sm:w-full lg:w-[1641px] lg:h-[661px] bg-blue-600/20'><img src={image} alt='twostory apartment' loading="lazy" className='w-full h-full object-cover' /></div>
        ...
        <main className='lg:w-full lg:h-[3288px] flex flex-col justify-between'>
            ...
            <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] mx-auto flex flex-row'>
                ...
                <h2 className='sm:text-[24px] lg:text-[50px] font-bold sm:mt-5 lg:mt-0'>Подробнее о ремонте двухэтажных квартир</h2>
            </div>
            ...
            <div className='sm:h-[4200px] lg:h-[1860px] sm:w-full lg:w-auto relative mx-auto '>
                ...
                <ul className='sm:h-[4200px] lg:h-full sm:w-full lg:w-[1641px] flex flex-col justify-between space-y-20'>
                    ...
                    <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row justify-between'>
                        ...
                        <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 px-6'>
                            <h2 className='font-bold sm:text-[42px] lg:text-[44px]'>КОМФОРТНАЯ ПЛАНИРОВКА</h2>
                    ...
                    <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row-reverse justify-between'>
                        ...
                        <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 px-6 lg:px-0 '>
                            <h2 className='font-bold sm:text-[42px] lg:text-[44px]'>ПЛАНИРОВКА ТЕРРАСЫ</h2>
                    ...
                    <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row justify-between'>
                        ...
                        {/* info */}
                        <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 px-6'>
                            <h2 className='font-bold sm:text-[42px] lg:text-[44px]'>РАСПОЛОЖЕНИЕ ЛЕСТНИЦЫ</h2>
                    ...
                    <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row-reverse justify-between'>
                        ...
                        <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 sm:px-6 lg:px-0'>
                            <h2 className='font-bold sm:text-[42px] lg:text-[44px]'>ВЕНТИЛЯЦИЯ И КОМФОРТ</h2>
                ...
                <div className='absolute w-[1303px] h-[460px] top-[1290px] scale-85 left-[280px] sm:hidden lg:block'><img src={arrow_2} alt='arrow 2'  className='w-full h-full'/></div>
            </div>
