    ...
    <div>
        ...
        <header className='lg:w-[1641px] sm:w-full lg:h-[1450px] mx-auto my-20 flex flex-col justify-between'>
            ...
            <div className='space-y-10'>
                ...
                {/* image */}
                <div className='sm:w-full lg:w-[1641px] lg:h-[661px] bg-blue-600/20'><img src={image} alt='exclusive renovation' loading="lazy" className='w-full h-full object-cover rounded-[10px]' /></div>
