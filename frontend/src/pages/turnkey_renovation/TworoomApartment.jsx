...
const TworoomApartment = () => {
  ...
  return (
    <div>
        ...
        {/* first step */}
        <header className={`lg:w-[1641px] sm:w-full ${(selectedLang === 'it' || selectedLang === 'en') ?'lg:h-[1350px]' :'lg:h-[1450px]'}  mx-auto my-20 flex flex-col justify-between`}>
            {/* header */}
            ...
            <div className='space-y-10'>
                ...
                {/* image */}
                <div className='sm:w-full lg:w-[1641px] lg:h-[661px] bg-blue-600/20'><img src={image} alt='tworoom apartment' loading="lazy"  className='w-full h-full object-cover rounded-[10px]' /></div>
        ...
        <main className='lg:w-full lg:h-[3288px] flex flex-col justify-between'>
            ...
            <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] mx-auto flex flex-row'>
                ...
                <h2 className={`${selectedLang === 'it' ? 'sm:text-[20px]  sm:mt-3' : ''} ${selectedLang === 'en' ? 'sm:text-[25px]  sm:mt-5' : ' '} ${selectedLang === 'ru' ? 'sm:text-[26px]  sm:mt-0' : ''} lg:text-[50px] font-bold  lg:mt-0`}>{t('process.h')}</h2>
            </div>

            <p className='sm:w-full lg:w-[1640px] sm:px-4 lg:px-0 text-[32px] mx-auto my-20 sm:text-center lg:text-start'>{t('process.p')}</p>

            {/* list of steps */}
            <div className='sm:h-[4200px] lg:h-[1848px] sm:w-full lg:w-auto relative mx-auto '>
