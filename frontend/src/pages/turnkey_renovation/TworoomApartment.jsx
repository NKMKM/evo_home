...
const TworoomApartment = () => {
  const { t } = useTranslation('turnkey_renovation/TworoomApartment')
    ...
    <div className="w-full min-h-screen">
      ...
      <header className="w-full max-w-[1641px] mx-auto my-6 sm:my-8 lg:my-10 flex flex-col justify-between px-4 lg:px-0">
        ...
        <div className="space-y-6 sm:space-y-8 lg:space-y-10">
          ...
          <div className="w-full bg-blue-600/20 rounded-[10px] overflow-hidden">
            <img src={image} alt='tworoom apartment' loading="lazy" className="w-full h-auto object-cover" />
          </div>
      ...
      <main className="w-full flex flex-col px-4 lg:px-0">
        ...
        <div className="w-full max-w-[1641px] mx-auto mb-8 sm:mb-10 lg:mb-12 relative">
          ...
          <div className="absolute top-[1100px] sm:top-[1280px] left-[180px] sm:left-[280px] w-[1100px] sm:w-[1303px] h-[400px] sm:h-[460px] scale-x-85 hidden lg:block">
