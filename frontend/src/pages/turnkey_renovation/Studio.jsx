...
const Studio = () => {
  return (
    <div>
        {/* first step */}
        <div className='lg:w-[1641px] sm:w-full lg:h-[1550px] mx-auto my-20 flex flex-col justify-between'>
            {/* header */}
            ...
            <div className='space-y-10'>
                ...
                <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] flex flex-row'>
                    ...
                    <h1 className='sm:text-[26px] lg:text-[50px] font-bold sm:mt-4.5 lg:mt-0'>Ремонт квартир-студий от EVO HOME</h1>
                </div>
        ...
        <div className='w-full sm:h-[7400px] lg:h-[4280px] flex flex-col justify-between '>
            {/* header */}
            <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] flex flex-row mx-auto '>
                ...
                <h1 className='sm:text-[28px] lg:text-[50px] font-bold sm:mt-4 lg:mt-0'>Подробнее о ремонте студий</h1>
            </div>
                ...
                <ul className='sm:h-[5500px] lg:h-[2813px] sm:w-full lg:w-[1641px]  flex flex-col justify-between space-y-20'>
                    ...
                    <li className='sm:w-[85%] lg:w-full  sm:ml-[5%] lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row  justify-between '>
                        ...
                        <div className='sm:w-full lg:w-[1082px] h-full  flex flex-col space-y-1  py-5 px-5 '>
                            <div>
                                <h1 className='font-bold text-[46px]'>ПРОФЕССИОНАЛЬНОЕ КОНСУЛЬТИРОВАНИЕ</h1>
                            </div>
                    ...
                    <li className='sm:w-[85%] lg:w-full  sm:ml-[5%] lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row-reverse  justify-between '>
                        ...
                        <div className='sm:w-full lg:w-[1082px] h-full  flex flex-col space-y-10  py-5 sm:px-5 lg:px-0  '>
                            <div>
                                <h1 className='font-bold text-[46px]'>ПЕРВОКЛАССНЫЕ МАТЕРИАЛЫ</h1>
                            </div>
                    ...
                    <li className='sm:w-[85%] lg:w-full  sm:ml-[5%] lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row  justify-between '>
                        ...
                        <div className='sm:w-full lg:w-[1082px] h-full  flex flex-col space-y-10  py-5 px-5 '>
                            <div>
                                <h1 className='font-bold text-[46px]'>ИНДВИДУАЛЬНЫЕ РЕШЕНИЯ</h1>
                            </div>
                    ...
                    <li className='sm:w-[85%] lg:w-full  sm:ml-[5%] lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row-reverse  justify-between '>
                        ...
                        <div className='sm:w-full lg:w-[1082px] h-full  flex flex-col space-y-10  py-5 sm:px-5 lg:px-0 lg:pr-5'>
                            <div>
                                <h1 className='font-bold text-[46px]'>ПРОЗРАЧНОСТЬ И НАДЕЖНОСТЬ</h1>
                            </div>
                    ...
                    <li className='sm:w-[85%] lg:w-full  sm:ml-[5%] lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row  justify-between '>
                        ...
                        <div className='sm:w-full lg:w-[1082px] h-full  flex flex-col space-y-10  py-5 px-5 '>
                            <div>
                                <h1 className='font-bold text-[42px]'>ОПЫТ И ГАРАНТИЯ</h1>
                            </div>
                    ...
                    <li className='sm:w-[85%] lg:w-full  sm:ml-[5%] lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row-reverse  justify-between '>
                        ...
                        <div className='sm:w-full lg:w-[1082px] h-full  flex flex-col space-y-10  py-5 sm:px-5 lg:px-0 '>
                            <div>
                                <h1 className='font-bold text-[46px]'>РЕМОНТ В РИМЕ И ОКРЕСТНОСТЯХ</h1>
                            </div>
