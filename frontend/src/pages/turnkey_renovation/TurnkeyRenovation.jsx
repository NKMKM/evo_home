...
const TurnkeyRenovation = () => {
  ...
  return (
    <div className="w-full min-h-screen">
      <Helmet>
        <title>{t('title')}</title>
        <meta name="description" content="🏠 Trasforma il tuo appartamento a Roma con ristrutturazioni chiavi in mano. Servizio completo e personalizzato. 📞 +39 327 986 6412" />
      </Helmet>
