...
const AboutUs = () => {
  return (
    <div>
        {/* about us block */}
        <div className='sm:w-full sm:h-[2270px] lg:w-[1641px] lg:h-[1243px] sm:px-5 lg:px-0 mx-auto mt-20 flex flex-col justify-between'>
            {/* header */}
            ...
            <div className='flex sm:flex-col lg:flex-row lg:w-[1639px]  sm:h-[1950px] lg:h-[914px] justify-between text-[32px]'>
                ...
                <div className='sm:w-full lg:w-[806px] lg:h-[914px]'><img src={van} className='w-full h-full'/></div>
            </div>
        ...
        <div className='relative sm:mt-10 lg:mb-40 sm:h-[2900px] lg:h-[826px]'>
            {/* vector 1 */}
            <div className='sm:bottom-[400px] sm:scale-150 lg:scale-100 lg:bottom-auto w-[515px] h-[823px] absolute '><img src={vector1} className='w-full h-full'/></div>
                ...
                <ul className=' sm:h-[2500px] flex sm:flex-col lg:flex-row justify-between'>
                    ...
                    <li className=' relative sm:w-[90%] sm:mx-auto lg:mx-0 lg:w-[278px] h-[420px] bg-linear-to-t from-[#83b1d6]  to-[#fcfdfe] shadow-2xl'>
                        <div className='flex flex-col justify-between h-full w-full py-10'>
                            <div className='sm:w-[100px] sm:h-[100px] lg:w-[64px] lg:h-[64px] mx-auto '><img src={bill} className='w-full h-full'/></div>
                            <h1 className='sm:text-[30px] lg:text-[22px] font-semibold text-center'>ИНДВИДУАЛЬНЫЙ <br/> ПОДХОД</h1>
                        ...
                        <div className='absolute top-[385px] sm:left-[270px] lg:left-[90px] w-[70px] h-[70px] border-[5px] border-white bg-[#F9BA4E] rounded-full text-center  '><p className='font-semibold text-[40px]'>1</p> </div>
                    </li>

                    {/* 2 */}
                    <li className=' relative sm:w-[90%] sm:mx-auto lg:mx-0 lg:w-[278px] h-[420px] bg-linear-to-t from-[#83b1d6]  to-[#fcfdfe] shadow-2xl'>
                        <div className='flex flex-col justify-between h-full w-full py-10'>
                            <div className='sm:w-[100px] sm:h-[100px] lg:w-[64px] lg:h-[64px] mx-auto '><img src={hands} className='w-full h-full'/></div>
                            <h1 className='sm:text-[30px] lg:text-[22px] font-semibold text-center'>ПРОЗРАЧНАЯ <br/> СМЕТА</h1>
                        ...
                        <div className='absolute top-[385px] sm:left-[270px] lg:left-[90px] w-[70px] h-[70px] border-[5px] border-white bg-[#F9BA4E] rounded-full text-center  '><p className='font-semibold text-[40px]'>2</p> </div>
                    </li>

                    {/* 3 */}
                    <li className=' relative sm:w-[90%] sm:mx-auto lg:mx-0 lg:w-[278px] h-[420px] bg-linear-to-t from-[#83b1d6]  to-[#fcfdfe] shadow-2xl'>
                        <div className='flex flex-col justify-between h-full w-full py-10'>
                            <div className='sm:w-[100px] sm:h-[100px] lg:w-[64px] lg:h-[64px] mx-auto '><img src={achievment} className='w-full h-full'/></div>
                            <h1 className='sm:text-[30px] lg:text-[22px] font-semibold text-center'>ВЫСОКОКАЧЕСТВЕННЫЕ <br/> МАТЕРИАЛЫ</h1>
                        ...
                        <div className='absolute top-[385px] sm:left-[270px] lg:left-[90px] w-[70px] h-[70px] border-[5px] border-white bg-[#F9BA4E] rounded-full text-center  '><p className='font-semibold text-[40px]'>3</p> </div>
                    </li>
                    ...
                    <li className=' relative sm:w-[90%] sm:mx-auto lg:mx-0 lg:w-[278px] h-[420px] bg-linear-to-t from-[#83b1d6]  to-[#fcfdfe] shadow-2xl'>
                        <div className='flex flex-col justify-between h-full w-full py-10'>
                            <div className='sm:w-[100px] sm:h-[100px] lg:w-[64px] lg:h-[64px] mx-auto '><img src={hands} className='w-full h-full'/></div>
                            <h1 className='sm:text-[30px] lg:text-[22px] font-semibold text-center'>УМНЫЙ <br/> ДОМ</h1>
                        ...
                        <div className='absolute top-[385px] sm:left-[270px] lg:left-[90px] w-[70px] h-[70px] border-[5px] border-white bg-[#F9BA4E] rounded-full text-center  '><p className='font-semibold text-[40px]'>4</p> </div>
                    </li>

                    {/* 5 */}
                    <li className=' relative sm:w-[90%] sm:mx-auto lg:mx-0 lg:w-[278px] h-[420px] bg-linear-to-t from-[#83b1d6]  to-[#fcfdfe] shadow-2xl'>
                        <div className='flex flex-col justify-between h-full w-full py-10'>
                            <div className='sm:w-[100px] sm:h-[100px] lg:w-[64px] lg:h-[64px] mx-auto '><img src={smart_home} className='w-full h-full'/></div>
                            <h1 className='sm:text-[30px] lg:text-[22px] font-semibold text-center'>СОБЛЮДЕНИЕ <br/> СРОКОВ</h1>
                        ...
                        <div className='absolute top-[385px] sm:left-[270px] lg:left-[90px] w-[70px] h-[70px] border-[5px] border-white bg-[#F9BA4E] rounded-full text-center  '><p className='font-semibold text-[40px]'>5</p> </div>
                    </li>
            ...
            {/* vector 2 */}
            <div className='w-[806px] h-[804px] sm:scale-125 lg:scale-100 right-0 sm:top-[300px] lg:top-0 absolute -z-10 '><img src={vector2} className='w-full h-full'/></div>
        ...
        <div className='sm:w-full lg:w-[1641px] lg:h-[1969px] mx-auto flex flex-col justify-between '>
            <div className='h-[83px] w-full mx-auto flex flex-row justify-between items-center  '>
                <img src={left_yellow_decoration} className='w-[276px] h-[83px] sm:hidden lg:block '/>
                <div className='sm:mx-auto lg:mx-0'>
                    <h1 className='font-bold text-center text-[57px]'>Команда EVO Home</h1>

                </div>
                <img src={right_yellow_decoration} className='w-[276px] h-[83px] sm:hidden lg:block'/>
            </div>
            ...
            <div className='relative sm:mb-10 lg:mb-0'>
                ...
                <ul className='h-auto  lg:w-[1641px] sm:px-10 lg:px-0  space-y-20'>
                    ...
                    <li className=' w-full  sm:h-[900px] lg:h-[376px] flex sm:flex-col lg:flex-row justify-between '>
                        {/* empolyee photo */}
                        <div className='sm:w-full lg:w-[528px] h-[376px] border-[5px] border-[#F9B33B]'><img src={founder} className='w-full h-full object-cover'/></div>
                    ...
                    <li className=' w-full sm:h-[900px] lg:h-[376px] flex sm:flex-col lg:flex-row-reverse justify-between border-b '>
                        {/* empolyee photo */}
                        <div className='sm:w-full lg:w-[528px] h-[376px] border-[5px] border-[#F9B33B]'><img src={designer} className='w-full h-full object-cover'/></div>
                    ...
                    <li className=' w-full  sm:h-[900px] lg:h-[376px] flex sm:flex-col lg:flex-row justify-between '>
                        {/* empolyee photo */}
                        <div className='sm:w-full lg:w-[528px] h-[376px] border-[5px] border-[#F9B33B]'><img src={project_manager} className='w-full h-full object-cover'/></div>
                    ...
                    <li className=' w-full sm:h-[850px] lg:h-[376px] flex sm:flex-col lg:flex-row-reverse justify-between border-b '>
                        {/* empolyee photo */}
                        <div className='sm:w-full lg:w-[528px] h-[376px] border-[5px] border-[#F9B33B]'><img src={engineer} className='w-full h-full object-cover'/></div>
                ...
                <div className='absolute w-[1605px] h-[338px]  bottom-[120px] sm:hidden lg:block'><img src={arrow_2}/></div>
            </div>
        ...
        <div className='sm:w-full lg:w-[1640px] sm:h-[4400px] lg:h-[938px] mx-auto my-10'>
            ...
            <div className='relative  sm:w-full lg:w-[1418px] h-[132px] text-center mx-auto mb-6 font-bold text-[#222222] items-center lg:border-r-[12px]  lg:border-r-[#E0E0E0] lg:border-l-[12px] lg:border-l-[#E0E0E0]'>
                <h1 className='sm:text-[66px] lg:text-[70px] absolute lg:top-[19px] lg:left-[410px] sm:px-5 lg:px-0 '>Наши достижения</h1>
            ...
            <ul className=' flex sm:flex-col  lg:flex-row justify-between border-amber-600 sm:w-full lg:w-[1640px] sm:px-10 lg:px-0 sm:h-[4200px] lg:h-[778px] text-[22px] text-center'>
                ...
                <li className=' sm:w-full lg:w-[389px] lg:h-full '>
                    {/* photo */}
                    <div className='lg:w-[389px] h-1/2 '><img src={first_image} className='w-full h-full'/></div>

                    {/* text */}
                    <div className='flex flex-col lg:w-[389px] h-1/2 py-10 space-y-10 border-[3px] border-[#F9B33B]'>
                        <div className='sm:w-[100px] sm:h-[100px] lg:w-[79px] lg:h-[79px] mx-auto'><img src={keys} className='w-full h-full'/></div>
                ...
                <li className=' sm:w-full lg:w-[389px] lg:h-full '>
                    {/* photo */}
                    <div className='lg:w-[389px] h-1/2 '><img src={second_image} className='w-full h-full'/></div>

                    {/* text */}
                    <div className='flex flex-col lg:w-[389px] h-1/2 py-10 space-y-10 border-[3px] border-[#F9B33B]'>
                        <div className='sm:w-[100px] sm:h-[100px] lg:w-[79px] lg:h-[79px] mx-auto'><img src={room} className='w-full h-full'/></div>
                ...
                <li className=' sm:w-full lg:w-[389px] lg:h-full '>
                    {/* photo */}
                    <div className='lg:w-[389px] h-1/2 '><img src={third_image} className='w-full h-full'/></div>

                    {/* text */}
                    <div className='flex flex-col lg:w-[389px] h-1/2 py-10 space-y-10 border-[3px] border-[#F9B33B]'>
                        <div className='sm:w-[100px] sm:h-[100px] lg:w-[79px] lg:h-[79px] mx-auto'><img src={botique} className='w-full h-full'/></div>
                ...
                <li className=' sm:w-full lg:w-[389px] lg:h-full '>
                    {/* photo */}
                    <div className='lg:w-[389px] h-1/2 '><img src={fourth_image} className='w-full h-full'/></div>

                    {/* text */}
                    <div className='flex flex-col lg:w-[389px] h-1/2 py-10 space-y-10 border-[3px] border-[#F9B33B]'>
                        <div className='sm:w-[100px] sm:h-[100px] lg:w-[79px] lg:h-[79px] mx-auto'><img src={gears} className='w-full h-full'/></div>
        ...
        <div className='relative lg:w-full lg:h-[1882px] sm:mt-20 lg:mt-0 mx-auto'>
            ...
            {/* header */}
            <div className='h-[83px] sm:w-full lg:w-[1641px] mx-auto flex flex-row justify-between items-center '>
                <img src={left_decoration} className='w-[276px] h-[83px] sm:hidden lg:block '/>
                <div className='sm:mx-auto lg:mx-0'>
            ...
            {/* grid images */}
            <div className='sm:w-full lg:w-[1641px] lg:h-[1641px] sm:px-10 lg:px-0 grid sm:gap-y-10 lg:gap-y-0  sm:grid-cols-1 sm:grid-rows-4 lg:grid-cols-2 lg:grid-rows-2 mx-auto mt-20'>

                {/* 1 */}
                <div className='sm:w-full sm:h-fit lg:w-[806px] lg:h-[806px]'><img src={image1} className='w-full h-full'/></div>
                
                {/* 2 */}
                <div className='sm:w-full sm:h-fit lg:w-[806px] lg:h-[806px]'><img src={image2} className='w-full h-full'/></div>
                
                {/* 3 */}
                <div className='sm:w-full sm:h-fit lg:w-[806px] lg:h-[806px]'><img src={image3} className='w-full h-full'/></div>
                
                {/* 4 */}
                <div className='sm:w-full sm:h-fit lg:w-[806px] lg:h-[806px]'><img src={image4} className='w-full h-full'/></div>
        ...
        <div className='w-full sm:h-[2550px]  lg:h-[909px] flex flex-col justify-between  my-20 mx-auto'>
            <h1 className='sm:text-[60px] lg:text-[50px] font-bold text-center'>Строим вместе с <br className='lg:hidden' />EVO HOME</h1>
            ...
            <div className='w-full sm:h-[2700px] lg:h-[696px] relative flex sm:flex-col lg:flex-row'>
                <div className='absolute  h-[853px] sm:top-0 lg:bottom-0 -z-10'><img src={vector_about_us_1} className='w-full h-full'/></div>
                ...
                <div className='absolute h-[853px] sm:bottom-[46px] lg:bottom-0 right-0 -z-10'><img src={vector_about_us_2} className='w-full h-full'/></div>
            </div>
