...
const CommercialPremisesRenovation = () => {
  ...
  return (
    <div className='w-full'>
        <Helmet>
            <title>{t('title')}</title>
            <meta name="description" content="Cerchi una ditta che si occupi della ristrutturazione di locali commerciali a Roma? Affidati ai nostri esperti. Trasforma il tuo locale con un tocco professionale. Contattaci 📞 +39 327 986 6412" />
        </Helmet>
        <header className='w-full max-w-[1641px] h-auto mx-auto mt-10 sm:mt-10 lg:mt-20 mb-10 sm:mb-20 lg:mb-20 px-4 flex flex-col justify-between gap-6'>
            ...
            <div className='space-y-6'>
                <div className='w-full max-w-[1640px] h-auto bg-[#F9B33B] flex flex-row items-center'>
                    ...
                    <h2 className='text-[20px] sm:text-[22px] lg:text-[50px] font-bold mt-2 sm:mt-4 lg:mt-0'>{t('header.h')}</h2>
                </div>
        ...
        <main className='w-full h-auto mb-10 sm:mb-20 lg:mb-20 px-4 flex flex-col justify-between'>
            <div className='w-full max-w-[1640px] h-auto bg-[#F9B33B] mx-auto flex flex-row items-center'>
                ...
                <h2 className='text-[20px] sm:text-[22px] lg:text-[50px] font-bold mt-2 sm:mt-4 lg:mt-0'>{t('process.h')}</h2>
            </div>
