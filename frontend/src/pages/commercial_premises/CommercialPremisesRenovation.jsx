...
const CommercialPremisesRenovation = () => {
  ...
  return (
    <div>
        ...
        {/* first step */}
        <header className={`lg:w-[1641px] sm:w-full ${selectedLang === 'it' ? 'lg:h-[1275px] ' : 'lg:h-[1375px] '}  mx-auto my-20 flex flex-col justify-between`}>
            {/* header */}
            ...
            <div className='space-y-10'>
                ...
                <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] flex flex-row'>
                    ...
                    <h2 className='sm:text-[22px] lg:text-[50px] font-bold sm:mt-5.5 lg:mt-0'>{t('header.h')}</h2>
                </div>
      ...
      <main className='sm:h-[6200px] lg:w-full lg:h-[3688px]  flex flex-col justify-between'>
        ...
        <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] mx-auto flex flex-row'>
            ...
            <h2 className='sm:text-[23px] lg:text-[50px] font-bold sm:mt-5.5 lg:mt-0'>{t('process.h')}</h2>
        </div>
