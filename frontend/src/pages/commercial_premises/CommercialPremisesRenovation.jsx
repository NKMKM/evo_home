...
const CommercialPremisesRenovation = () => {
  return (
    <div>
        <Helmet>
            <title>Реновация коммерческих помещений</title>
            <meta name="description" content="Renovation of commercial premises by EVO Home" />
        </Helmet>
        {/* first step */}
        <header className='lg:w-[1641px] sm:w-full lg:h-[1375px] mx-auto my-20 flex flex-col justify-between'>
            {/* header */}
            ...
            <div className='space-y-10'>
                ...
                <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] flex flex-row'>
                    ...
                    <h2 className='sm:text-[22px] lg:text-[50px] font-bold sm:mt-5.5 lg:mt-0'>Реновация коммерческих помещений от EVO HOME</h2>
                </div>
      ...
      <main className='sm:h-[6200px] lg:w-full lg:h-[3688px]  flex flex-col justify-between'>
        ...
        <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] mx-auto flex flex-row'>
            ...
            <h2 className='sm:text-[23px] lg:text-[50px] font-bold sm:mt-5.5 lg:mt-0'>Подробнее о ремонте коммерческих помещений</h2>
        </div>
            ...
            <ul className='sm:h-[4750px] lg:h-full sm:w-full lg:w-[1641px] flex flex-col justify-between space-y-20'>
                ...
                <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row justify-between'>
                    ...
                    <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 px-6'>
                        <h2 className='font-bold sm:text-[42px] lg:text-[44px]'>ТОРГОВЫЕ ЦЕНТРЫ</h2>
                ...
                <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row-reverse justify-between'>
                    ...
                    <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 '>
                        <h2 className='font-bold sm:text-[42px] lg:text-[44px]'>РАЗВЛЕКАТЕЛЬНЫЕ КОМПЛЕКСЫ</h2>
                ...
                <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row justify-between'>
                    ...
                    {/* info */}
                    <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 px-6'>
                        <h2 className='font-bold sm:text-[42px] lg:text-[44px]'>КРУПНЫЕ СУПЕРМАРКЕТЫ</h2>
                ...
                <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row-reverse justify-between'>
                    ...
                    {/* info */}
                    <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 px-6'>
                        <h2 className='font-bold sm:text-[42px] lg:text-[44px]'>СПЕЦИАЛИЗИРОВАННЫЕ МАГАЗИНЫ</h2>
                ...
                <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row justify-between'>
                    ...
                    {/* info */}
                    <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 px-6'>
                        <h2 className='font-bold sm:text-[42px] lg:text-[44px]'>КАФЕ, РЕСТОРАНЫ И БАРЫ</h2>
