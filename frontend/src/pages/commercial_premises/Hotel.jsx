    ...
    <div>
        ...
        <header className={`lg:w-[1641px] sm:w-full ${(selectedLang === 'it' || selectedLang === 'en') ? 'lg:h-[1325px] ' : 'lg:h-[1425px] '} mx-auto my-20 flex flex-col justify-between`}>
            ...
            <div className='h-[83px] w-full mx-auto flex flex-row justify-between items-center sm:mb-10 lg:mb-0'>
                ...
                <h1 className={`font-bold mx-auto text-center ${selectedLang === 'it' ? 'sm:text-[56px] lg:text-[57px]' : 'sm:text-[60px] lg:text-[57px]'} `}>{t('h')}</h1>
            ...
            <div className='space-y-10'>
                ...
                {/* image */}
                <div className='sm:w-full lg:w-[1641px] lg:h-[661px] bg-blue-600/20'><img src={image} alt='hotel' loading="lazy"  className='w-full h-full object-cover rounded-[10px]' /></div>
