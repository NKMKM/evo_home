...
const CommercialPremises = () => {
  return (
    <div>
        {/* first step */}
        <div className='sm:w-full  lg:w-[1641px] sm:h-[1900px] lg:h-[1677px] mx-auto sm:mt-10 lg:mt-20 mb-30 flex flex-col justify-between'>
            {/* header */}
            <div className='h-[83px] md:w-full sm:my-10 lg:my-0 mx-auto flex flex-row justify-between items-center '>
                ...
                <div className=''>
                    <h1 className='font-bold text-center  sm:text-[50px] md:text-[57px]'>Коммерческие помещения</h1>
            ...
            <div className='sm:h-[1700px]  lg:h-[1510px] flex flex-col justify-between  '>
                ...
                <div className='lg:w-[1640px] h-[74px] bg-[#F9B33B] flex flex-row'>
                    ...
                    <h1 className='sm:text-[29px] sm:mt-4 lg:mt-0 lg:text-[50px] font-bold'>Реновация коммерческих помещений</h1>
                </div>
        ...
        <div className='w-full sm:h-[8200px]  lg:h-[4503px] lg:mb-20 flex flex-col   justify-between '>
            {/* header */}
            <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] mx-auto flex flex-row'>
                ...
                <h1 className='sm:text-[26px] lg:text-[50px] font-bold'>Подробнее о ремонте коммерческих помещений</h1>
            </div>
                    ...
                    <ul className='sm:h-[6700px]  lg:h-[3213px] sm:w-full lg:w-[1641px]  flex flex-col justify-between space-y-20'>
                        ...
                        <li className='sm:w-[85%] lg:w-full  sm:ml-[5%] lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row  justify-between '>
                            ...
                            <div className='sm:w-full lg:w-[1082px] h-full  flex flex-col space-y-10  py-5 lg:px-5 '>
                                <div>
                                    <h1 className='font-bold text-[46px]'>РЕНОВАЦИЯ БИЗНЕС ЦЕНТРА</h1>
                                </div>
                        ...
                        <li className='sm:w-[85%] lg:w-full  sm:ml-[5%] lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row  justify-between '>
                            ...
                            <div className='sm:w-full lg:w-[1082px] h-full  flex flex-col space-y-10  py-5 px-5 '>
                                <div>
                                    <h1 className='font-bold text-[46px]'>РЕМОНТ ОФИСА</h1>
                                </div>
                        ...
                        <li className='sm:w-[85%] lg:w-full  sm:ml-[5%] lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row-reverse  justify-between '>
                            ...
                            <div className='sm:w-full lg:w-[1082px] h-full  flex flex-col space-y-10  py-5 px-5 '>
                                <div>
                                    <h1 className='font-bold text-[46px]'>РЕНОВАЦИЯ БАРОВ И РЕСТОРАНОВ</h1>
                                </div>
                        ...
                        <li className='sm:w-[85%] lg:w-full  sm:ml-[5%] lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row  justify-between '>
                            {/* process photo */}
                            <div className=' sm:w-full lg:w-[667px] h-full border-[5px] border-[#F9B33B]'><img src={image} className='w-full h-full object-cover'/></div>
    
                            {/* info */}
                            <div className='sm:w-full lg:w-[1082px] h-full  flex flex-col space-y-10  py-5 lg:px-5 '>
                                <div>
                                    <h1 className='font-bold text-[42px]'>РЕНОВАЦИЯ СКЛАДОВ</h1>
                                </div>
                        ...
                        <li className='sm:w-[85%] lg:w-full  sm:ml-[5%] lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row-reverse  justify-between '>
                            ...
                            <div className='sm:w-full lg:w-[1082px] h-full  flex flex-col space-y-10  py-5 px-5 '>
                                <div>
                                    <h1 className='font-bold text-[46px]'>РЕНОВАЦИЯ ФИТНЕС КЛУБОВ</h1>
                                </div>
                        ...
                        <li className='sm:w-[85%] lg:w-full  sm:ml-[5%] lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row  justify-between '>
                            ...
                            <div className='sm:w-full lg:w-[1082px] h-full  flex flex-col space-y-10  py-5 px-5 '>
                                <div>
                                    <h1 className='font-bold text-[46px]'>РЕНОВАЦИЯ ГОСТИННИЦЫ</h1>
                                </div>
