...
const Office = () => {
  ...
  return (
    <div>
        ...
        {/* first step */}
        <heder className={`lg:w-[1641px] sm:w-full ${(selectedLang === 'it' || selectedLang === 'en') ? 'lg:h-[1350px]' : 'lg:h-[1440px]'}  mx-auto my-20 flex flex-col justify-between`}>
            {/* header */}
            ...
            <div className='space-y-10'>
                ...
                {/* image */}
                <div className='sm:w-full lg:w-[1641px] lg:h-[661px] bg-blue-600/20'><img src={image} alt='office' loading="lazy" className='w-full h-full object-cover rounded-[10px]' /></div>
        ...
        {/* process */}
      <main className='sm:h-[5600px] lg:w-full lg:h-[3688px]  flex flex-col justify-between'>
        {/* header */}
