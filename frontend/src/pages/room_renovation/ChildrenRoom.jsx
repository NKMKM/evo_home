    ...
    <div>
        ...
        <header className={`lg:w-[1641px] sm:w-full ${selectedLang === 'it' ? 'lg:h-[1350px]' : 'lg:h-[1450px]'} lg:h-[1450px] mx-auto my-20 flex flex-col justify-between`}>
            ...
            <div className='space-y-13'>
                ...
                {/* image */}
                <div className='sm:w-full lg:w-[1641px] lg:h-[661px] bg-blue-600/20'><img src={image} alt='children room' loading="lazy" className='w-full h-full object-cover rounded-[10px]' /></div>
        ...
        <main className='lg:w-full sm:h-[7000px]  lg:h-[3788px]  flex flex-col justify-between'>
            ...
            <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] mx-auto flex flex-row'>
                ...
                <h2 className={`${(selectedLang === 'it' || selectedLang === 'en')? 'sm:text-[20px]  sm:mt-5' : 'sm:text-[25px] sm:mt-4 '} lg:text-[40px] font-bold  lg:mt-0`}>{t('process.h')}</h2>
            </div>
