...
const ChildrenRoom = () => {
  return (
    <div>
        ...
        <div className='lg:w-[1641px] sm:w-full lg:h-[1450px] mx-auto my-20 flex flex-col justify-between'>
            ...
            <div className='space-y-10'>
                ...
                <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] flex flex-row'>
                    ...
                    <h1 className='sm:text-[26px] lg:text-[50px] font-bold sm:mt-5 lg:mt-0'>Ремонт детской комнаты от EVO HOME</h1>
                </div>
        ...
        {/* process */}
        <div className='lg:w-full sm:h-[7000px]  lg:h-[3788px]  flex flex-col justify-between'>
            {/* header */}
            <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] mx-auto flex flex-row'>
                ...
                <h1 className='sm:text-[21px] lg:text-[50px] font-bold sm:mt-6 lg:mt-0'>Подробнее о ремонте детской комнаты от EVO HOME </h1>
            </div>
                ...
                <ul className='sm:h-[4950px] lg:h-full sm:w-full lg:w-[1641px] flex flex-col justify-between space-y-20'>
                    ...
                    <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row-reverse justify-between'>
                        ...
                        <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 px-6 lg:px-0 '>
                            <h1 className='font-bold sm:text-[42px] lg:text-[44px]'>ТЕМАТИЧЕСКАЯ ПЕРСОНАЛИЗАЦИЯ</h1>
                    ...
                    <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row justify-between'>
                        ...
                        {/* info */}
                        <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 px-6'>
                            <h1 className='font-bold sm:text-[42px] lg:text-[44px]'>ЭКОЛОГИЧНОСТЬ МАТЕРИАЛОВ</h1>
                    ...
                    <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row-reverse justify-between'>
                        ...
                        <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 sm:px-6 lg:px-0'>
                            <h1 className='font-bold sm:text-[42px] lg:text-[44px]'>ТЕХНОЛОГИИ И ИННОВАЦИИ</h1>
                    ...
                    <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row justify-between'>
                        ...
                        {/* info */}
                        <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 px-6'>
                            <h1 className='font-bold sm:text-[42px] lg:text-[44px]'>ЗОНА ДЛЯ УЧЕБЫ</h1>
