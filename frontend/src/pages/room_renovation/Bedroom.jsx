    ...
    <div>
        ...
        <header className='lg:w-[1641px] sm:w-full lg:h-[1350px] mx-auto my-20 flex flex-col justify-between'>
            ...
            <div className='space-y-10'>
                ...
                <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] flex flex-row'>
                    ...
                    <h2 className='sm:text-[26px] lg:text-[50px] font-bold sm:mt-4 lg:mt-0'>Ремонт спальни от EVO HOME</h2>
                </div>
                ...
                {/* image */}
                <div className='sm:w-full lg:w-[1641px] lg:h-[661px] bg-blue-600/20'><img src={image} alt='bedroom' loading="lazy" className='w-full h-full object-cover' /></div>
        ...
        <main className='lg:w-full lg:h-[3788px]  flex flex-col justify-between'>
            ...
            <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] mx-auto flex flex-row'>
                ...
                <h2 className='sm:text-[26px] lg:text-[50px] font-bold sm:mt-4 lg:mt-0'>Подробнее о ремонте спальни от EVO HOME </h2>
            </div>
                ...
                <ul className='sm:h-[4850px] lg:h-full sm:w-full lg:w-[1641px] flex flex-col justify-between space-y-20'>
                    ...
                    <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row justify-between'>
                        ...
                        <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 px-6'>
                            <h2 className='font-bold sm:text-[42px] lg:text-[44px]'>СТЕНЫ</h2>
                    ...
                    <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row justify-between'>
                        ...
                        {/* info */}
                        <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 px-6'>
                            <h2 className='font-bold sm:text-[42px] lg:text-[44px]'>ПОТОЛОК</h2>
                    ...
                    <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row-reverse justify-between'>
                        ...
                        <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 sm:px-6 lg:px-0'>
                            <h2 className='font-bold sm:text-[42px] lg:text-[44px]'>НАЧНИТЕ СО ЗВОНКА</h2>
                    ...
                    <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row justify-between'>
                        ...
                        {/* info */}
                        <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 px-6'>
                            <h2 className='font-bold sm:text-[42px] lg:text-[44px]'>ПРОФЕССИОНАЛЬНАЯ ОЦЕНКА НА МЕСТЕ </h2>
