...
const Stairs = () => {
  return (
    <div>
        {/* first step */}
        <div className='sm:w-full  lg:w-[1641px] sm:h-[1900px] lg:h-[1728px] mx-auto my-20 flex flex-col justify-between'>
            {/* header */}
            ...
            <div className=' space-y-10 '>
                ...
                <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] flex flex-row'>
                    ...
                    <h1 className='sm:text-[34px] lg:text-[50px] sm:mt-3 lg:mt-0 font-bold'>Ремонт лестниц от EVO HOME</h1>
                </div>
        ...
        <div className='w-full sm:h-[5900px] lg:h-[3323px]   flex flex-col justify-between '>
            {/* header */}
            <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] flex flex-row mx-auto '>
                ...
                <h1 className='sm:text-[25px] lg:text-[50px] font-bold sm:mt-5 lg:mt-0 '>Подробнее о ремонте лестниц от EVO HOME</h1>
            </div>
                    ...
                    <ul className='lg:h-[1794px] sm:w-full lg:w-[1641px]  flex flex-col justify-between space-y-20'>
                        ...
                        <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row justify-between'>
                            ...
                            <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 px-6'>
                                <h1 className='font-bold sm:text-[42px] lg:text-[44px]'>МЕТАЛЛИЧЕСКИЕ ЛЕСТНИЦЫ</h1>
                        ...
                        <li className='sm:w-[85%] lg:w-full  sm:ml-[5%] lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row-reverse  justify-between '>
                            ...
                            <div className='sm:w-full lg:w-[1082px] h-full  flex flex-col space-y-10  py-5 sm:px-5 lg:px-0  '>
                                <div>
                                    <h1 className='font-bold text-[46px]'>БЕТОННЫЕ ЛЕСТНИЦЫ</h1>
                                </div>
                        ...
                        <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row justify-between'>
                            ...
                            {/* info */}
                            <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 px-6'>
                                <h1 className='font-bold sm:text-[42px] lg:text-[44px]'>ДЕРЕВЯННЫЕ ЛЕСТНИЦЫ</h1>
                        ...
                        <li className='sm:w-[85%] lg:w-full  sm:ml-[5%] lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row-reverse  justify-between '>
                            {/* process photo */}
                            <div className=' sm:w-full lg:w-[667px] sm:h-[378px] h-full border-[5px] border-[#F9B33B]'><img src={fourth_step} className='w-full h-full object-cover'/></div>

                            {/* info */}
                            <div className='sm:w-full lg:w-[1082px] h-full  flex flex-col space-y-10  py-5 sm:px-5 lg:px-0  '>
                                <div>
                                    <h1 className='font-bold text-[46px]'>КАМЕННЫЕ ЛЕСТНИЦЫ</h1>
                                </div>
