    ...
    <div>
        ...
        <div className='sm:w-full  lg:w-[1641px] sm:h-[1500px] lg:h-[1677px] mx-auto sm:mt-10 lg:mt-20 mb-30 flex flex-col justify-between'>
            ...
            <div className='h-[83px] md:w-full mx-auto flex flex-row justify-between items-center '>
                ...
                <div className=''>
                    <h1 className='font-bold text-center sm:text-[50px] md:text-[57px]'>Системы</h1>
            ...
            <div className='sm:h-[1400px] lg:h-[1577px] flex flex-col justify-between  '>
                ...
                <div className='lg:w-[1640px] h-[74px] bg-[#F9B33B] flex flex-row'>
                    ...
                    <h1 className='sm:text-[45px] lg:text-[50px] font-bold'>Системы от EVO HOME</h1>
                </div>
        ...
        <div className='w-full lg:h-[4703px] lg:mb-40 flex flex-col justify-between '>
            {/* header */}
            <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] mx-auto flex flex-row'>
                ...
                <h1 className='sm:text-[45px] lg:text-[50px] font-bold'>Подробнее о системах</h1>
            </div>
            ...
            <div className=' w-full lg:h-[1050px] flex flex-col justify-between  my-20 mx-auto'>
                ...
                <div className='lg:w-[1641px] lg:h-[336px] sm:text-center lg:text-start flex flex-col space-y-5 my-10 mx-auto text-[30px]'>
                    ...
                    <p>Свяжитесь с нами сегодня по телефону <br className='md:hidden'/>  <span className='underline cursor-default'>+39 327 986 6412</span>, чтобы получить бесплатную консультацию или запросить персональное предложение.</p>
                </div>
