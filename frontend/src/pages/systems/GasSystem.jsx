    ...
    <div>
      ...
      <div className='lg:w-[1641px] sm:w-full lg:h-[1447px] mx-auto my-20 flex flex-col justify-between'>
        ...
        <div className='space-y-10'>
          <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] flex flex-row'>
            ...
            <h1 className='sm:text-[26px] lg:text-[50px] font-bold sm:mt-4 lg:mt-0'>Установка газовой системы от EVO HOME</h1>
          </div>
      ...
      <div className='lg:w-full lg:h-[4088px]  flex flex-col justify-between'>
        <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] mx-auto flex flex-row'>
          ...
          <h1 className='sm:text-[26px] lg:text-[50px] font-bold sm:mt-4 lg:mt-0'>Подробнее об установке газовой системы</h1>
        </div>
          ...
          <ul className='sm:h-[5550px] lg:h-full sm:w-full lg:w-[1641px] flex flex-col justify-between space-y-20'>
            <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row justify-between'>
              ...
              <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-8 py-5 px-6'>
                <h1 className='font-bold sm:text-[42px] lg:text-[44px]'>СЧЕТЧИК</h1>
            ...
            <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row-reverse justify-between'>
              <div className='sm:w-full sm:h-[400px] lg:w-[667px] lg:h-full border-[5px] border-[#F9B33B]'><img src={second_step} className='w-full h-full object-cover' /></div>
              <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-10 py-5 px-5'>
                <h1 className='font-bold sm:text-[42px] lg:text-[46px]'>ПОЛЬЗОВАТЕЛЬСКИЕ УСТРОЙСТВА</h1>
            ...
            <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row justify-between'>
              ...
              <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-5 py-5 px-10'>
                <h1 className='font-bold sm:text-[42px] lg:text-[48px]'>СОВРЕМЕННЫЕ СИСТЕМЫ УПРАВЛЕНИЯ</h1>
            ...
            <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row-reverse justify-between'>
              ...
              <div className='sm:w-full lg:w-[1082px] h-full flex flex-col space-y-10 py-5 px-5'>
                <h1 className='font-bold sm:text-[42px] lg:text-[48px]'>ГАРАНТИЯ СООТВЕТСТВИЯ UNI CIG  7129</h1>
            ...
            <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 lg:h-[384px] flex sm:flex-col lg:flex-row justify-between'>
              ...
              <div className='sm:w-full lg:w-[1082px] h-full flex flex-col px-10 space-y-4 py-5'>
                <h1 className='font-bold sm:text-[42px] lg:text-[48px]'>ПОЛНЫЙ СПЕКТР УСЛУГ</h1>
