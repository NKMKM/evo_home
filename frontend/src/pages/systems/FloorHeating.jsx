...
const FloorHeating = () => {
  return (
    <div>
        <Helmet>
            <title>Система теплого пола</title>
      ...
      <header className='lg:w-[1641px] sm:w-full lg:h-[1447px] mx-auto my-20 flex flex-col justify-between'>
        ...
        <div className='space-y-10'>
          <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] flex flex-row'>
            ...
            <h2 className='sm:text-[24px] lg:text-[50px] font-bold sm:mt-4 lg:mt-0'>Установка системы "Тёплый пол" от EVO HOME</h2>
          </div>
          ...
          <div className='sm:w-full lg:w-[1641px] lg:h-[661px] bg-blue-600/20'><img src={image} alt='floor heating' loading="lazy" className='w-full h-full object-cover' /></div>
      ...
      <main className='lg:w-full lg:h-[4088px]  flex flex-col justify-between'>
        <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] mx-auto flex flex-row'>
          ...
          <h2 className='sm:text-[24px] lg:text-[50px] font-bold sm:mt-4 lg:mt-0'>Подробнее об установке системы "Тёплый пол"</h2>
        </div>
          ...
          <ul className='sm:h-[4650px] lg:h-full sm:w-full lg:w-[1641px] flex flex-col justify-between '>
            <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 flex sm:flex-col lg:flex-row justify-between'>
              ...
              <div className='sm:w-full lg:w-[1082px] flex flex-col space-y-4 py-5 px-6'>
                <h2 className='font-bold sm:text-[42px] lg:text-[46px]'>ПЕРВИЧНАЯ КОНСУЛЬТАЦИЯ И ОЦЕНКА</h2>
            ...
            <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 flex sm:flex-col lg:flex-row-reverse justify-between'>
              ...
              <div className='sm:w-full lg:w-[1082px] flex flex-col space-y-4 py-5 px-6'>
                <h2 className='font-bold sm:text-[42px] lg:text-[46px]'>ДЕТАЛЬНОЕ ПРОЕКТИРОВАНИЕ</h2>
            ...
            <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 flex sm:flex-col lg:flex-row justify-between'>
              ...
              <div className='sm:w-full lg:w-[1082px] flex flex-col space-y-4 py-5 px-6'>
                <h2 className='font-bold sm:text-[42px] lg:text-[48px]'>НАГРЕВ ВОДЫ</h2>
            ...
            <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 flex sm:flex-col lg:flex-row-reverse justify-between'>
              ...
              <div className='sm:w-full lg:w-[1082px] flex flex-col space-y-4 py-5 px-6'>
                <h2 className='font-bold sm:text-[42px] lg:text-[48px]'>ЭЛЕКТРИЧЕСКОЕ ОТОПЛЕНИЕ</h2>
            ...
            <li className='sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 flex sm:flex-col lg:flex-row justify-between'>
              ...
              <div className='sm:w-full lg:w-[1082px] flex flex-col space-y-4 py-5 px-6'>
                <h2 className='font-bold sm:text-[42px] lg:text-[48px]'>ТЕСТЫ И ОКОНЧАТЕЛЬНЫЕ НАСТРОЙКИ</h2>
