...
const Sewage = () => {
  return (
    <div>
      <div className="lg:w-[1641px] sm:w-full lg:h-[1447px] mx-auto my-20 flex flex-col justify-between">
        ...
        <div className="space-y-20">
          <div className="sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] flex flex-row">
            ...
            <h1 className="sm:text-[25px] lg:text-[50px] font-bold sm:mt-4 lg:mt-0">Установка системы дренажа и канализации </h1>
          </div>
      ...
      <div className="sm:h-[5650px] lg:h-auto lg:w-full flex flex-col ">
        <div className="sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] mx-auto sm:mb-20  flex flex-row">
          ...
          <h1 className="sm:text-[24px] lg:text-[50px] font-bold  sm:mt-4 lg:mt-0">Подробнее о установке дренажа и канализации</h1>
        </div>
        ...
        <div className="sm:h-[5150px]  lg:h-[2470px]  sm:w-full lg:w-auto  relative mx-auto  lg:mb-30">
          <div className="lg:w-[1377px] lg:h-[646px] scale-x-80 absolute top-[380px] left-[220px] sm:hidden lg:block">
            <img src={arrow_1} className="w-full h-full" />
          </div>
          ...
          <ul className="sm:h-full  lg:h-full  sm:w-full  lg:w-[1641px]  flex flex-col justify-between space-y-20">
            ...
            <li className="sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 flex sm:flex-col lg:flex-row justify-between">
              <div className="sm:w-full lg:w-[667px] border-[5px] border-[#F9B33B]">
                <img src={first_step} className="w-full h-full object-cover" />
              </div>
              <div className="sm:w-full lg:w-[1082px] flex flex-col space-y-4 py-5 px-6">
                <h1 className="font-bold sm:text-[42px] lg:text-[46px]">ПЛАНИРОВАНИЕ И ДИЗАЙН</h1>
            ...
            <li className="sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 flex sm:flex-col lg:flex-row-reverse justify-between">
              <div className="sm:w-full lg:w-[667px] border-[5px] border-[#F9B33B]">
                <img src={second_step} className="w-full h-full object-cover" />
              </div>
              <div className="sm:w-full lg:w-[1082px] flex flex-col space-y-4 py-5 px-6">
                <h1 className="font-bold sm:text-[42px] lg:text-[46px]">МОНТАЖ ТРУБ</h1>
                <ul className="list-disc text-[30px] px-16">
            ...
            <li className="sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 flex sm:flex-col lg:flex-row justify-between">
              <div className="sm:w-full lg:w-[667px] border-[5px] border-[#F9B33B]">
                <img src={third_step} className="w-full h-full object-cover" />
              </div>
              <div className="sm:w-full lg:w-[1082px] flex flex-col space-y-4 py-5 px-6">
                <h1 className="font-bold sm:text-[42px] lg:text-[48px]">СПЕЦИАЛЬНЫЕ КОМПОНЕНТЫ</h1>
                <ul className="list-disc text-[30px] px-16">
            ...
            <li className="sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 flex sm:flex-col lg:flex-row-reverse justify-between">
              <div className="sm:w-full lg:w-[667px] border-[5px] border-[#F9B33B]">
                <img src={fourth_step} className="w-full h-full object-cover" />
              </div>
              <div className="sm:w-full lg:w-[1082px] flex flex-col space-y-4 py-5 px-6">
                <h1 className="font-bold sm:text-[42px] lg:text-[48px]">ОБЩЕСТВЕННАЯ КАНАЛИЗАЦИЯ</h1>
                <ul className="list-disc text-[30px] px-16">
            ...
            <li className="sm:w-[85%] sm:ml-[7%] lg:w-full lg:ml-0 flex sm:flex-col lg:flex-row justify-between">
              <div className="sm:w-full lg:w-[667px] border-[5px] border-[#F9B33B]">
                <img src={fifth_step} className="w-full h-full object-cover" />
              </div>
              <div className="sm:w-full lg:w-[1082px] flex flex-col space-y-4 py-5 px-6">
                <h1 className="font-bold sm:text-[42px] lg:text-[48px]">ТЕСТИРОВАНИЕ И ПРОВЕРКА</h1>
                <ul className="list-disc text-[30px] px-16">
          ...
          <div className="w-[1604px] h-[627px] absolute top-[1435px] left-0 sm:hidden lg:block">
            <img src={arrow_2} className="w-full h-full" />
          </div>
        </div>
