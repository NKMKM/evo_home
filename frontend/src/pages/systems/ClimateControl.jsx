...
const ClimateControl = () => {
  ...
  return (
    <div>
      ...
      <header className={`lg:w-[1641px] sm:w-full ${(selectedLang === 'it' || selectedLang === 'en') ? "lg:h-[1270px] " : 'lg:h-[1300px] '} mx-auto my-20 flex flex-col justify-between`}>
        ...
        <div className='space-y-10'>
          <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] flex flex-row'>
            ...
            <h2 className='sm:text-[22px] lg:text-[50px] font-bold sm:mt-4 lg:mt-0'>{t('header.h')}</h2>
          </div>
          ...
          <div className='sm:w-full lg:w-[1641px] lg:h-[661px] bg-blue-600/20'><img src={image} alt='climate control' loading="lazy" className='w-full h-full object-cover rounded-[10px]' /></div>
      ...
      <main className='sm:h-[6150px]  lg:h-auto lg:w-full flex flex-col '>
        <div className='sm:w-full lg:w-[1640px] h-[74px] bg-[#F9B33B] mx-auto sm:mb-20  flex flex-row'>
          ...
          <h2 className={`${selectedLang === 'it' ? 'sm:text-[20px]  sm:mt-3' : 'sm:text-[24px] sm:mt-4 '} lg:text-[42px] font-bold  lg:mt-0`}>{t('process.h')}</h2>
        </div>
