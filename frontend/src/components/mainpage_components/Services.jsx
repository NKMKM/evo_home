            ...
            <div className=' sm:w-full lg:w-[1641px] '>
                <ul className='sm:h-[3900px]  sm:w-full lg:w-[1641px] mx-auto flex sm:flex-col lg:flex-row justify-between '>
                    ...
                    <li className='sm:w-[90%] sm:mx-auto lg:mx-0 lg:w-[389px]  h-[933px]  flex flex-col justify-between py-2'>
                        ...
                        <Link to="/room_renovation" className='h-[67px] bg-[#F9B33B] flex justify-center items-center hover:scale-110 transition duration-300 font-semibold text-[30px] shadow-2xl'>УЗНАТЬ ПОДРОБНЕЕ</Link>
                    </li>
                    ...
                    <li className='sm:w-[90%] sm:mx-auto lg:mx-0 lg:w-[389px]  h-[933px]  flex flex-col justify-between pb-[12px]'>
                        ...
                        <Link to={'/commercial_premises'} className='h-[67px] bg-[#F9B33B] flex justify-center items-center hover:scale-110 transition duration-300 font-semibold text-[30px] shadow-2xl'>УЗНАТЬ ПОДРОБНЕЕ</Link>
                    </li>
                    ...
                    <li className='sm:w-[90%] sm:mx-auto lg:mx-0 lg:w-[389px]  h-[933px]  flex flex-col justify-between py-2'>
                        ...
                        <Link to="/systems" className='h-[67px] bg-[#F9B33B] flex justify-center items-center hover:scale-110 transition duration-300 font-semibold text-[30px] shadow-2xl'>УЗНАТЬ ПОДРОБНЕЕ</Link>
                    </li>
