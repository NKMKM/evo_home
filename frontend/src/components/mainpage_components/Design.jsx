...
const Design = () => {
    ...
    <div className="flex flex-col  justify-around w-full min-h-[480px]   md:min-h-[800px] design-bg-image bg-cover">
      ...
      <div className="flex flex-row h-[80px] md:h-[200px] lg:bg-black/55 pt-4 md:pt-0">
        ...
        {/* Days */}
        <div className="flex flex-col items-center justify-center bg-[#64b1d9] text-black w-[39%] md:w-[25%] p-4 md:p-5 lg:mr-[40px]">
      ...
      {/* Comment */}
      <div className="flex items-center bg-black/58 text-white text-[20px] sm:text-xl md:text-[29px] font-[200] px-4 py-6 md:px-32 md:py-0 md:h-[130px]">
      ...
      <div className="w-full  flex flex-col-reverse md:flex-row md:justify-around md:h-[270px] gap-6 lg:p-4 md:p-0">
        ...
        {/* Conditions */}
        <div className="md:w-[500px] bg-black/55  md:border-6 lg:border-[#f9b33b] lg:rounded-lg text-white px-4 md:px-5 md:py-6 lg:backdrop-blur-sm">
          <p className="font-semibold text-xl md:text-3xl hidden lg:inline">{t('condition.h')}</p>
          <ul className=" text-center font-[200] lg:font-[500] lg:text-start pl-6 pt-2 md:pt-4 text-base md:text-[22px]">
