...
const Reviews = () => {
  return (
    <div className='home-reviews-bg-image w-full h-[1030px] bg-cover mb-20 p-20'>
        {/* header section */}
        <div className='w-[1650px] h-[170px]  mx-auto flex flex-row justify-between items-center  '>
        ...
        <p className='text-white text-[32px] italic font-light w-[600px] mx-auto text-center mb-9'>"Реальные отзывы о работе EVO HOME"</p>


        <div className='w-[1641px] mx-auto flex flex-row items-center justify-between'>
            {/* 1 */}
            <div className="relative flex flex-col w-[453px] h-[415px] bg-white  p-10 shadow-2xl justify-between ">
            ...
            {/* 2 */}
            <div class="relative flex flex-col w-[667px] h-[610px] bg-white  p-10 shadow-2xl space-y-10 ">
            ...
            {/* 3 */}
            <div class="relative flex flex-col w-[453px] h-[415px] bg-white  p-10 shadow-2xl justify-between ">
                ...
                <p>"Сделали ремонт в ванной и кухне – просто супер! Работы выполнены аккуратно, сантехника установлена идеально, а плитка выглядит шикарно. Очень понравилось, что не было скрытых платежей, всё по договору. Спасибо EVO HOME!"</p>
