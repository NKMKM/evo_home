...
const Reviews = () => {
  return (
    <div className='home-reviews-bg-image w-full sm:h-[2450px] lg:h-[1030px] bg-cover mb-20 p-20'>
        {/* header section */}
        <div className='sm:w-full lg:w-[1650px] h-[170px]  mx-auto flex flex-row justify-between items-center sm:mb-10 lg:mb-0  '>
        ...
        <div className='sm:w-full sm:h-[1900px]  lg:h-auto lg:w-[1641px] mx-auto flex sm:flex-col lg:flex-row items-center justify-between'>
            {/* 1 */}
