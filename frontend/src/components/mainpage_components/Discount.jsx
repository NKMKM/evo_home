...
const Discount = () => {
    ...
    <div className="flex flex-col  justify-around w-full min-h-[600px]  md:min-h-[800px] discount-bg-image bg-cover">
      ...
      <div className="flex flex-row h-[90px] md:h-[200px] lg:bg-black/55 pt-4 md:pt-0">
        ...
        {/* Days */}
        <div className="flex flex-col items-center justify-center bg-[#ffb429] text-black w-[40%] md:w-[25%] p-4 md:p-5">
      ...
      <div className="w-full  flex flex-col-reverse md:flex-row md:justify-around md:h-[270px] gap-6 lg:p-4 md:p-0">
        ...
        {/* Conditions */}
        <div className="md:w-[500px] bg-black/55  md:border-6 lg:border-[#f9b33b] lg:rounded-lg text-white px-4 md:px-5 md:py-9 lg:backdrop-blur-sm">
