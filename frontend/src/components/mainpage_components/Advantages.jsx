...
const Advantages = () => {
  ...
  <div className=' lg:w-full sm:h-[2750px] sm:flex sm:flex-col sm:justify-between  lg:h-[1100px]  lg:mb-[630px] '>
          ...
          {/* header */}
          <div className=' lg:w-[1418px]  h-[184px] text-center mx-auto mt-20 sm:mb-30 lg:mb-20 font-bold text-[#222222] items-center lg:border-r-[12px]  lg:border-r-[#E0E0E0] lg:border-l-[12px] lg:border-l-[#E0E0E0]'>
            <h1 className='sm:text-[50px] lg:text-[60px] '>Профессиональный ремонт,</h1>
            <div className="flex flex-row justify-between">
              <div className='w-[155px] h-[12px] bg-[#E0E0E0] sm:hidden lg:block'></div>
              <div className='w-[155px] h-[12px] bg-[#E0E0E0] sm:hidden lg:block'></div>
            </div>
            <h1 className='sm:text-[50px] lg:text-[60px] mb-2'> которому можно доверять!</h1>
          </div>

          {/* main info */}

          <div className='flex sm:flex-col lg:flex-row sm:h-[2000px] lg:h-[1166px]  sm:w-full lg:w-[1655px] mx-auto  justify-between'>
            ...
            <div className='relative grid sm:grid-cols-2 lg:grid-cols-2 lg:grid-rows-3 sm:gap-y-[80px] lg:gap-x-[100px] lg:gap-y-[30px] lg:w-[735px] items-center sm:h-[800px] lg:h-auto lg:my-auto  '>
                <div className='flex flex-col items-center'>
                  ...
                  <img src={right_arrow} className='z-10 absolute md:top-[150px] md:left-[33.6%] lg:top-[155px] lg:left-[215px] scale-[0.6] sm:hidden md:block'/>
                ...
                <div className='flex flex-col items-center'>
                  ...
                  <img src={bottom_arrow} className='z-10 absolute sm:right-[10px] sm:top-[240px] md:right-[7%] lg:top-[227px] lg:right-[10px] scale-[0.6]'/>
                  <div className='flex flex-col items-center text-center space-y-2 px-4 w-[312px] h-[250px] rounded-[10px] border-[#F9B33B] border-[5px]'>
                ...
                <div className='flex flex-col items-center'>
                  ...
                  <img src={left_arrow} className='z-10 absolute lg:top-[450px] lg:left-[215px] scale-[0.6] sm:hidden md:block'/>
                  <div className='flex flex-col items-center text-center space-y-2 px-4 w-[312px] h-[250px] rounded-[10px] border-[#F9B33B] border-[5px]'>
                ...
                <div className='flex flex-col items-center'>
                  ...
                  <img src={bottom_arrow} className='z-10 absolute sm:top-[620px] sm:left-[15px] md:left-[7.5%] lg:top-[540px] lg:left-[10px] scale-[0.6]'/>
                  <div className='flex flex-col items-center text-center space-y-2 px-4 w-[312px] h-[250px] rounded-[10px] border-[#F9B33B] border-[5px]'>
                ...
                <div className='flex flex-col items-center'>
                  ...
                  <img src={right_arrow} className='z-10 absolute md:top-[900px] md:left-[33.6%] lg:top-[810px] lg:left-[215px] scale-[0.55] sm:hidden md:block'/>
                  <div className='flex flex-col items-center text-center space-y-2 px-4 w-[312px] h-[250px] rounded-[10px] border-[#F9B33B] border-[5px]'>
                ...
                <Link to="/contacts" className='sm:w-[500px] sm:ml-[25%] md:ml-[50%] lg:w-[734px] h-[67px] flex justify-center items-center lg:mx-auto bg-[#F9B33B] rounded-[10px]  lg:mt-[110px] text-3xl font-bold cursor-pointer hover:scale-110 transition duration-300'>ЗАПРОСИТЬ РАСЦЕНКИ</Link>
          ...
          <p className='font-[400] sm:text-center sm:text-[36px] md:text-[32px] sm:w-full lg:w-[1640px] mx-auto md:my-20 '>Команда квалифицированных специалистов и  постоянная приверженность к качеству позволяют нам удовлитворить все ваши потребности в ремонте, гарантируя обговоренные сроки.</p>
