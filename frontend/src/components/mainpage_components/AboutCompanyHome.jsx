  ...
  return (
    <div className='mb-20 w-[1641px] mx-auto'>
        ...
        <div className='h-[170px] w-full mx-auto flex flex-row justify-between items-center mb-20 '>
            ...
            <div className=''>
                <h1 className='font-bold text-center text-[70px]'>О компании  EVO HOME</h1>

            </div>
            <img src={right_decoration} className='w-[276px] h-[83px]'/>
        </div>
        <div className='w-[1622px] h-[538px]  mx-auto flex flex-row justify-between mb-20'>

            {/* img comparison slider */}
            <div className='w-[836px] h-[536px] '>
            ...
            <div className='flex flex-col w-[836px] p-4 space-y-10'>
        ...
        <div className='w-[1640px] flex flex-row items-center mx-auto'>
