...
const Guarantees = () => {
  return (
    <div className='relative lg:mb-40 sm:h-[2900px] lg:h-[826px]'>
            ...
            <ul className=' sm:h-[2500px] flex sm:flex-col lg:flex-row justify-between'>
                ...
                <li className=' relative sm:w-[90%] sm:mx-auto lg:mx-0 lg:w-[278px] h-[420px] bg-linear-to-t from-[#83b1d6]  to-[#fcfdfe] shadow-2xl'>
                    <div className='flex flex-col justify-between h-full w-full py-10'>
                        ...
                        <h1 className='sm:text-[30px] lg:text-[22px] font-semibold text-center'>ГАРАНТИЯ <br/> КАЧЕСТВА</h1>
                ...
                <li className=' relative sm:w-[90%] sm:mx-auto lg:mx-0 lg:w-[278px] h-[420px] bg-linear-to-t from-[#83b1d6]  to-[#fcfdfe] shadow-2xl'>
                    <div className='flex flex-col justify-between h-full w-full py-10'>
                        ...
                        <h1 className='sm:text-[30px] lg:text-[22px] font-semibold text-center'>ПРОФЕССИОНАЛЬНЫЙ <br/> ПОДХОД</h1>
                ...
                <li className=' relative sm:w-[90%] sm:mx-auto lg:mx-0 lg:w-[278px] h-[420px] bg-linear-to-t from-[#83b1d6]  to-[#fcfdfe] shadow-2xl'>
                    <div className='flex flex-col justify-between h-full w-full py-10'>
                        <div className='sm:w-[100px] sm:h-[100px] lg:w-[64px] lg:h-[64px] mx-auto '><img src={time} className='w-full h-full'/></div>
                ...
                <li className=' relative sm:w-[90%] sm:mx-auto lg:mx-0 lg:w-[278px] h-[420px] bg-linear-to-t from-[#83b1d6]  to-[#fcfdfe] shadow-2xl'>
                    <div className='flex flex-col justify-between h-full w-full py-10'>
                        <div className='sm:w-[100px] sm:h-[100px] lg:w-[64px] lg:h-[64px] mx-auto '><img src={hands} className='w-full h-full'/></div>
                        <h1 className='sm:text-[30px] lg:text-[22px] font-semibold text-center'>ЮРИДИЧЕСКАЯ <br/> ЗАЩИТА</h1>
                ...
                <li className=' relative sm:w-[90%] sm:mx-auto lg:mx-0 lg:w-[278px] h-[420px] bg-linear-to-t from-[#83b1d6]  to-[#fcfdfe] shadow-2xl'>
                    <div className='flex flex-col justify-between h-full w-full py-10'>
                        <div className='sm:w-[100px] sm:h-[100px] lg:w-[64px] lg:h-[64px] mx-auto '><img src={time} className='w-full h-full'/></div>
                        <h1 className='sm:text-[30px] lg:text-[22px] font-semibold text-center'>ПРОЗРАЧНОСТЬ  <br/> ЦЕН</h1>
        ...
        {/* vector 2 */}
        <div className='sm:w-full sm:h-auto lg:w-[806px] lg:h-[804px] lg:scale-100 lg:right-0 sm:top-[300px] lg:top-0 absolute -z-10 '><img src={vector2} className='w-full h-full object-cover'/></div>
