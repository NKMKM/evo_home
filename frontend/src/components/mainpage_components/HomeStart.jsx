...
const HomeStart = () => {
  ...
  return (
    <div className="relative sm:w-full">
      ...
      <div className="absolute sm:top-[50px] sm:left-[30px] lg:top-[150px] lg:left-[88px]  shadow-2xl sm:w-[90%] lg:w-[1414px] lg:h-[580px] sm:h-[494px] z-10  bg-gradient-to-r from-gray-300/90 via-70% via-gray-300/40 to-gray-300/0 rounded-[10px] px-10 py-14">
        ...
        <ul className="text-[#222222]  lg:space-y-10  lg:text-6xl font-semibold lg:w-full  lg:text-start sm:text-5xl">
          ...
          <li>
            {t('list.second_stroke.text_1')} <span className="  lg:text-white">{t('list.second_stroke.span')}</span> {t('list.second_stroke.text_2')}
          </li>
          <li>
            {t('list.third_stroke.text')} <span className= " lg:text-white">{t('list.third_stroke.span')}</span> 
          </li>
        </ul>
