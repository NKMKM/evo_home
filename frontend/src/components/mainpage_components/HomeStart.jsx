...
const HomeStart = () => {
  ...
  return (
    <div className="relative w-full">
      ...
      <div className="absolute top-18 sm:top-18 md:top-10 lg:top-40 left-4 sm:left-6 lg:left-24 w-[90%] sm:w-[85%] lg:w-[90%] max-w-[1980px] bg-gradient-to-r from-gray-300/90 via-70% via-gray-300/65 to-gray-300/0 rounded-[10px] px-4 sm:px-6 lg:px-10 py-6 sm:py-8 lg:py-12 z-10 shadow-2xl">
