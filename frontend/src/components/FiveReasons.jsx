...
const FiveReasons = () => {
  return (
    <div className='relative h-[826px] '>
        ...
        {/* header text         */}
        <div className='w-[1353px] h-[136px] mx-auto mb-40 '>
            <h1 className='text-[70px] font-bold text-center w-[1353px] mx-auto'>5 причин разработать дизайн с EvoHome</h1>
            ...
            <ul className='flex flex-row justify-between'>
                ...
                <li className=' relative w-[278px] h-[420px] bg-linear-to-t from-[#83b1d6]  to-[#fcfdfe] shadow-2xl'>
                    <div className='flex flex-col justify-between h-full w-full py-10'>
                        ...
                        <p className='bg-[#d7e4ef] text-[18px] w-full h-[156px] p-4 text-center '>Наша команда обладает знаниями и опытом, необходимыми для того, чтобы преобразить каждый метр вашего пространства</p>

                    </div>

                    <div className='absolute top-[385px] left-[90px] w-[70px] h-[70px] border-[5px] border-white bg-[#F9BA4E] rounded-full text-center  '><p className='font-semibold text-[40px]'>1</p> </div>
                </li>
                ...
                <li className=' relative w-[278px] h-[420px] bg-linear-to-t from-[#83b1d6]  to-[#fcfdfe] shadow-2xl'>
                    <div className='flex flex-col justify-between h-full w-full py-10'>
                        ...
                        <p className='bg-[#d7e4ef] w-full h-[156px] text-[18px] p-4 text-center'>в EvoHome оплата производится по счету, что позволяет вам оплачивать фактически выполненную работу.</p>
                ...
                <li className=' relative w-[278px] h-[420px] bg-linear-to-t from-[#83b1d6]  to-[#fcfdfe] shadow-2xl'>
                    <div className='flex flex-col justify-between h-full w-full py-10'>
                        ...
                        <p className='bg-[#d7e4ef] w-full h-[156px] text-[16.5px] p-4 text-center'>Мы предоставляем официальные договоры на все проекты, в которых подробно описывается каждый этап работы, стоимость и сроки.</p>
                ...
                <li className=' relative w-[278px] h-[420px] bg-linear-to-t from-[#83b1d6]  to-[#fcfdfe] shadow-2xl'>
                    <div className='flex flex-col justify-between h-full w-full py-10'>
                        ...
                        <p className='bg-[#d7e4ef] w-full h-[156px] text-[18px] p-4 text-center'>Мы предлагаем 3-летнюю гарантию на выполненную работу, демонстрируя нашу приверженность качеству и долгосрочным результатам.</p>
                ...
                <li className=' relative w-[278px] h-[420px] bg-linear-to-t from-[#83b1d6]/100  to-[#fcfdfe] shadow-2xl'>
                    <div className='flex flex-col justify-between h-full w-full py-10'>
                        ...
                        <p className='bg-[#d7e4ef] w-full h-[156px] text-[16px] p-4 text-center'>Вы полагаетесь на опытного и надежного партнера для ремонта вашей гостиной, и вам гарантированы качество, безопасность и прозрачность проекта.</p>
